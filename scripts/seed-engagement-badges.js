...
async function seedBadges() {
  console.log('🏆 SEED: Badges Engagement\n');
  console.log('═'.repeat(100));

  try {
    // Badges Engagement - Assiduité et login streaks
    const badges = [
      {
        code: 'ENGAGEMENT_ACTIF',
        name: 'Actif',
        description: 'Présent 3 jours consécutifs',
        emoji: '📅✨',
      ...
      {
        code: 'ENGAGEMENT_ASSIDU',
        name: 'Assidu',
        description: 'Fidèle au poste - 7 jours consécutifs',
        emoji: '📅⭐',
        color: '#3498db', // Rare
        rarity: 'rare',
        category: 'engagement',
      ...
      {
        code: 'ENGAGEMENT_DEVOU',
        name: 'Dévoué',
        description: 'Engagement exemplaire - 14 jours consécutifs',
        emoji: '📅💎',
        color: '#9b59b6', // Epic
        rarity: 'epic',
        category: 'engagement',
      ...
      {
        code: 'ENGAGEMENT_MARATHONIEN',
        name: 'Marathonien',
        description: 'Endurance légendaire - 30 jours consécutifs',
        emoji: '📅🏆',
      ...
      {
        code: 'ENGAGEMENT_ETERNEL',
        name: 'Éternel',
        description: 'Fidélité absolue - 90 jours consécutifs',
        emoji: '📅👑✨',
        color: '#e74c3c', // Mythic
        rarity: 'mythic',
        category: 'engagement',
    ...
    console.log(`✅ ${badgeResults.rows.length} badges Engagement en base de données:\n`);
    ...
    console.log('\n' + '═'.repeat(100));
    console.log('✅ SEED ENGAGEMENT BADGES TERMINÉ\n');
